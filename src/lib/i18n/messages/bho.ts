...
export const bho: Messages = {
  ...
  forecast: {
    ...
    totalExpected: "कुल {mm} मिमी के अनुमान",
    peakLine:
      "सबसे तेज {mm} मिमी/घंटा {when} के लगे। हलका रंग वाली पट्टी शहर के सबसे भीजल हिस्सा ह; गाढ़ा वाली औसत ह।",
    noRain: "अगिला बारह घंटा में कवनो खास बरखा के अनुमान नइखे।",
    whenRoadsChange: "सड़क के हालत कब बदली",
    nothingChanges:
      "आजु कवनो सड़क के कदम उठावे वाली सीमा पार करे के अनुमान नइखे।",
    modelDepth: "अनुमानित पानी के गहिराई",
    axisMax: "सबसे जादे",
    peakRoadsAtRisk: "खतरा में सड़क, सबसे जादे",
    modelId: "मॉडल",
    modelNote:
      "गाढ़ लाइन शहर में कहीं के सबसे गहिर पानी बा; टूटल लाइन ओह सड़कन के औसत जहवाँ पानी बा। बिंदी वाला निशान 30 सेमी के बा, जहाँ आम कार रुक जाले। बरखा बंद भइला के बाद भी ई लाइन चढ़ते रहेला, काहे कि बड़ नाला तब्बो उलट के बहत रहेला।",
    alreadyWet: "पहिलहीं भीजल",
    beyondWindow: "आधी रात के बाद",
    caveat:
      "ई बरखा के अनुमान से निकालल बा, असल में नापल पानी से ना। पानी उतरे के समय तबे सही बा जब पंप चलत रही।",
  },
