...
export const bho: Messages = {
  ...
  hero: {
    ...
    lede:
      "FloodPilot बतावेला कि शहर में कहवाँ पानी भरी, केतना गहिर आ कब — फेर एगो खास आदमी के, ओकर खास गाड़ी के हिसाब से बतावेला कि का करे के बा।",
  ...
  route: {
    ...
    whatWeRecommend: "जवन FloodPilot सलाह देला",
