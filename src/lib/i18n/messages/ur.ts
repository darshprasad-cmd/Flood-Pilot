...
export const ur: Messages = {
  ...
  hero: {
    ...
    lede:
      "FloodPilot بتاتا ہے کہ شہر میں کہاں پانی جمع ہوگا، کتنا گہرا اور کب — پھر ایک مخصوص شخص کو، اس کی مخصوص گاڑی کے حساب سے بتاتا ہے کہ کرنا کیا ہے۔",
  ...
  route: {
    ...
    whatWeRecommend: "جو FloodPilot تجویز کرتا ہے",
