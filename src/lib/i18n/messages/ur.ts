...
export const ur: Messages = {
  ...
  forecast: {
    tab: "پیشگوئی",
    rainNext12h: "بارش، اگلے 12 گھنٹے",
    totalExpected: "{mm} ملی میٹر متوقع",
    peakLine:
      "سب سے تیز بارش {when} کے آس پاس، {mm} ملی میٹر فی گھنٹہ۔ ہلکی پٹی شہر کے سب سے زیادہ بھیگنے والے حصے کی ہے؛ گہری پٹی اوسط کی۔",
    noRain: "اگلے بارہ گھنٹوں میں کوئی خاص بارش کی پیشگوئی نہیں ہے۔",
    whenRoadsChange: "سڑکیں کب بدلیں گی",
    nothingChanges:
      "آج کسی سڑک کے اُس حد تک پہنچنے کی پیشگوئی نہیں جہاں کچھ کرنا پڑے۔",
    modelDepth: "اندازاً پانی کی گہرائی",
    axisMax: "زیادہ سے زیادہ",
    peakRoadsAtRisk: "خطرے میں سڑکیں، زیادہ سے زیادہ",
    modelId: "ماڈل",
    modelNote:
      "گہری لکیر شہر میں کہیں بھی سب سے گہرا پانی ہے؛ ٹوٹی لکیر اُن سڑکوں کی اوسط جہاں پانی ہے۔ نقطوں والا نشان 30 سینٹی میٹر کا ہے، جہاں عام کار رک جاتی ہے۔ بارش رکنے کے بعد بھی یہ لکیر اوپر جاتی رہتی ہے، کیونکہ بڑے نالے اُس وقت بھی اُلٹ کر بہہ رہے ہوتے ہیں۔",
    alreadyWet: "پہلے ہی پانی ہے",
    beyondWindow: "آدھی رات کے بعد",
    caveat:
      "یہ اندازہ بارش کی پیشگوئی سے لگایا گیا ہے، زمین پر دیکھے گئے پانی سے نہیں۔ پانی اترنے کے اوقات یہ مان کر بتائے گئے ہیں کہ پمپ چل رہے ہیں۔",
  },
