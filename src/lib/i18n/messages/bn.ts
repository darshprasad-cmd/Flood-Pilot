...
export const bn: Messages = {
  ...
  forecast: {
    tab: "পূর্বাভাস",
    rainNext12h: "বৃষ্টি, পরের ১২ ঘণ্টা",
    totalExpected: "আনুমানিক {mm} মিমি",
    peakLine:
      "সবচেয়ে ভারী বৃষ্টি {when} নাগাদ, {mm} মিমি/ঘণ্টা। হালকা দণ্ডটি শহরের সবচেয়ে ভেজা অংশ; গাঢ় দণ্ডটি গড়।",
    noRain: "আগামী বারো ঘণ্টায় উল্লেখযোগ্য বৃষ্টির পূর্বাভাস নেই।",
    whenRoadsChange: "রাস্তার অবস্থা কখন বদলাবে",
    nothingChanges:
      "আজ কোনও রাস্তারই ব্যবস্থা নেওয়ার সীমা পেরোনোর পূর্বাভাস নেই।",
    modelDepth: "অনুমিত জলের গভীরতা",
    axisMax: "সর্বোচ্চ",
    peakRoadsAtRisk: "ঝুঁকিতে থাকা রাস্তা, সর্বোচ্চ",
    modelId: "মডেল",
    modelNote:
      "গাঢ় রেখা শহরের যেকোনও জায়গার সবচেয়ে গভীর জল; ভাঙা রেখা যেসব রাস্তায় জল আছে তাদের গড়। ফুটকি দেওয়া দাগটি ৩০ সেমি, যেখানে সাধারণ গাড়ি থেমে যায়। বৃষ্টি থামার পরেও এই রেখা উঠতে থাকে, কারণ বড় নালাগুলি তখনও উল্টো বইছে।",
    alreadyWet: "আগে থেকেই ভেজা",
    beyondWindow: "মধ্যরাতের পরে",
    caveat:
      "বৃষ্টির পূর্বাভাস থেকে অনুমান করা — সরেজমিনে মাপা জল নয়। জল নামার সময় ধরে নেয় যে পাম্পগুলি চলছে।",
  },
